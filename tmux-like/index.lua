...
function ____exports.apply_to_config(config)
    ...
    __TS__ArrayPushArray(
        key_table_tmux,
        {
            ...
            {key = "z", mods = "NONE", action = wezterm.action.TogglePaneZoomState},
            {
                key = "q",
                mods = "NONE",
                action = wezterm.action:PaneSelect({alphabet = "1234567890"})
            },
            {key = "p", mods = "NONE", action = wezterm.action.ActivateCommandPalette},
            {
                key = "-",
                mods = "NONE",
    ...
    config.key_tables = __TS__ObjectAssign({}, config.key_tables, {tmux_mode = key_table_tmux, tmux_tab_navigation_mode = key_table_tmux_tab_navigation, tmux_pane_navigation_mode = key_table_tmux_pane_navigation, tmux_pane_resize_mode = key_table_tmux_pane_resize})
end
return ____exports
